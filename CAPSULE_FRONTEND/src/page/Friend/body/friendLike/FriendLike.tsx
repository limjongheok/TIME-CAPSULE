...
import AttractionCard from "./AttractionFriendLikeCard";
...
interface Props {
  friendInfo: Info | undefined;
}

const Located: React.FC<Props> = ({ friendInfo }) => {
  ...
  useEffect(() => {
    if (friendInfo && friendInfo.email) {
      loadPlaces(friendInfo.email);
    }
  }, [friendInfo]);
